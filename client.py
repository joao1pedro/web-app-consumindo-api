...
@app.route('/')
def index():
    response = requests.get('https://api-modelos-ia.herokuapp.com/modelo', headers=headers)
...
def create():
    ...
    requests.post('https://api-modelos-ia.herokuapp.com/modelo', json={'nome':nome, 'descricao': descricao}, headers=headers)
